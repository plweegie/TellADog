...
@Singleton
@Component(modules = [MyAppModule::class, AndroidInjectionModule::class,
    RoomModule::class, FirebaseModule::class, MachineLearningModule::class])
interface MyAppComponent {
    fun inject(fragment: DogListFragment)
    fun inject(cameraFragment: CameraFragment)
    fun inject(viewModel: PredictionListViewModel)
}